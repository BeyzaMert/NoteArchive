...
import notes from '../assets/data/vizefinal'
import VizeFinalList from '../components/UI/VizeFinalList'
...
const Arsiv = () => {
 ...
 const handleSearch= e => {
  ...
  return <Helmet title='Vize Final Soruları Yükle'>
   <CommonSection title='Vize ve Final Soruları'/>
