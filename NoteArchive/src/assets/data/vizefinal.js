...
const products = [
  {
    id: "01",
    noteName: "Tüuuurkçe Sınavları",
    imgUrl: noteImg01,
    category: "ilkokul",
    price: 193,
    shortDesc:
      "3.sınıf Türkçe sınavı örneğidir.",
    description:
      "3.sınıf Türkçe yazım kuralları sınavı örneğidir.",
    reviews: [
      {
        rating: 4.7,
...

  {
    ...
    price: 253,
    shortDesc:
      "4.sınıf İngilizce sınavı örneğidir.",
    description:
      "4.sınıf İngilizce Colors konusunun sınavı örneğidir.",
    reviews: [
      {
        rating: 4.8,
...

  {
    ...
    price: 173,
    shortDesc:
      "3. sınıf İngilizce sınavı örneğidir.",
    description:
      "3.sınıf İngilizce Numbers sınavı örneğidir.",
    reviews: [
      {
        rating: 3.6,
  ...
  // },
  {
    ...
    price: 163,
    shortDesc:
      "4. sınıf Matematik sınavı örneğidir.",
    description:
      "4. sınıf Matematik tam sayılar sınavı örneğidir.",
    reviews: [
      {
        rating: 1.6,
...

  {
    ...
    price: 163,
    shortDesc:
      "5. sınıf Matematik sınavı örneğidir.",
    description:
      "5. sınıf Matematik kesirler sınavı örneğidir.",
    reviews: [
      {
        rating: 4.6,
        text: "Beğendim.",
...

  {
    ...
    description:
      "8. sınıf Matematik problemler sınavı örneğidir.",
    reviews: [
      {
        rating: 1.6,
  ...
  },
  {
    ...
    price: 99,
    shortDesc:
      "7.sınıf Matematik sınavı örneğidir.",
    description:
      "7. sınıf Matematik denklemler sınavı örneğidir.",
    reviews: [
      {
        rating: 3.6,
...

  {
    ...
    price: 89,
    shortDesc:
      "Lise 1 Coğrafya sınavı örneğidir.",
    description:
      "Lise 1 Coğrafya iklimler sınavı örneğidir.",
    reviews: [
      {
        rating: 4.6,
        text: "Anlaşılır",
...

  {
    ...
    price: 112,
    shortDesc:
      "Lise 2 Coğrafya sınavı örneğidir.",
    description:
      "Lise 2 Coğrafya doğal afetler sınavı örneğidir.",
    reviews: [
      {
        rating: 4.6,
        text: "Gayet iyi",
...

  {
    ...
    price: 799,
    shortDesc:
      "Lise 4 Matematik sınavı örneğidir.",
    description:
      "Lise 4 Türev konusu sınavı örneğidir.",
    reviews: [
      {
        rating: 3.8,
  ...
  // },
  {
    ...
    shortDesc:
      "Lise 4 Matematik sınavı örneğidir.",
    description:
      "Lise 4 İntegral konusu sınavı örneğidir.",
    reviews: [
      {
        rating: 4.8,
  ...
  {
    id: "12",
    noteName: "İngilizce Öğretmenliği Notu",
    imgUrl: noteImg12,
    category: "universite",
    price: 599,
    shortDesc:
      "İngilizce Öğretmenliği sınavı örneğidir.",
    description:
      "İngilizce öğretmenliği edebiyat sınavı örneğidir.",
    reviews: [
      {
        rating: 1.8,
        text: "Çok karışık.",
...

  {
    ...
    price: 799,
    shortDesc:
      "Üniversite matematik sınavı örneğidir",
    description:
      "Üniversite Matematik dersi Analitik Geometri sınavı örneğidir",
    reviews: [
      {
        rating: 4.8,
        text: "Çok iyi.",
  ...
  {
    id: "14",
    noteName: "Bilgisayar Mühendisliği Notu",
    imgUrl: noteImg14,
    category: "universite",
    price: 899,
    shortDesc:
      "Bilgisayar Mühendisliği sınavı örneğidir.",
    description:
      "Bilgisayar Mühendisliği Bulut Bilişim sınavı örneğidir.",
    reviews: [
      {
        rating: 3.2,
...

  {
    ...
    price: 699,
    shortDesc:
      "Yapay Zeka sınavı örneğidir.",
    description:
      "Yapay Zeka deney sınavı örneğidir.",
    reviews: [
      {
        rating: 4.8,
